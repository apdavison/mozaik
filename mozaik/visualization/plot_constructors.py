...
class PerStimulusPlot(PerDSVPlot):
    ...
    title_style = param.String(
        default="Clever", instantiate=True, doc="The style of the title"
    )
...
class ADSGridPlot(Parameterized):
    ...
    def make_grid_plot(self, subplotspec):
        ...
        gs = gridspec.GridSpecFromSubplotSpec(
            len(self.y_axis_values), len(self.x_axis_values), subplot_spec=subplotspec
        )
